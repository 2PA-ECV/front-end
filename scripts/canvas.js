...
// Función para animar el "MATCH 2PA"
function animateMatch2PA() {
    const hearts = [];
    const particles = [];
    const heartCount = 100;
    const textSize = 100;
    const textColor = "#FF4081";
    const text = "MATCH 2PA!";
    let frame = 0;
    let hue = 0;
    ...
    // Función para dibujar un arco entre dos puntos (representando la conexión entre amigos)
    function drawConnectionArc(x1, y1, x2, y2, color) {
        ctx.save();
        ctx.beginPath();
        ctx.moveTo(x1, y1);
    ...
    function animate() {
        ...
        // Dibujar conexión entre dos puntos (representando el match 2PA)
        const connectionX1 = canvas.width / 2 - 200;
        const connectionY1 = canvas.height / 2;
        const connectionX2 = canvas.width / 2 + 200;
        const connectionY2 = canvas.height / 2;
        drawConnectionArc(connectionX1, connectionY1, connectionX2, connectionY2, "#FF4081");
